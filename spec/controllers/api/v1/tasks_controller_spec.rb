...
RSpec.describe API::V1::TasksController, type: :controller do
  ...
  # API::V1::TasksController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new API::V1::Task" do
        expect {
          post :create, params: {api/v1_task: valid_attributes}, session: valid_session
        }.to change(API::V1::Task, :count).by(1)
      end
      ...
      it "renders a JSON response with the new api/v1_task" do
        ...
        expect(response.location).to eq(api/v1_task_url(API::V1::Task.last))
      end
    end
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new api/v1_task" do
        ...
        post :create, params: {api/v1_task: invalid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested api/v1_task" do
        task = API::V1::Task.create! valid_attributes
        put :update, params: {id: task.to_param, api/v1_task: new_attributes}, session: valid_session
        task.reload
      ...
      it "renders a JSON response with the api/v1_task" do
        ...
        put :update, params: {id: task.to_param, api/v1_task: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the api/v1_task" do
        ...
        put :update, params: {id: task.to_param, api/v1_task: invalid_attributes}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
